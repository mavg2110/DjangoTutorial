...
from .views import HomePageView, AboutPageView, ProductIndexView, ProductShowView, ProductCreateView, ContactPageView, CartView, CartRemoveAllView, ImageViewFactory, ImageLocalStorage, ImageViewNoDI
